...
public class RegisterInformal extends Activity {
...
*/
        ...
        final String[] values = new String[]{"The Face Of Alegria","Mr. and Ms. Alegria","Fitness Physique","Fashion Street",
                                              "Gem of the City - Treasure Hunt","Photography","Fastest Finger First","PTV Rowdies"};
