...
public class RegisterFA extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // FirebaseAuth x = FirebaseAuth.getInstance();
        ...
        final String[] values = new String[]{"Poster Mania","Artistic Fantasy","Art of Colours","Intricate Patterns",
                                              "Mask Me","Nail Fantasy","Blot The Tee","Sketching"};
