...
public class RegisterWorkshops extends Activity {
...
*/
        ...
        final String[] values = new String[]{"Theatre","Calligraphy","Bokwa","Stippling Art","DJ Workshop","Salsa","Rubik's Cube",
                                             "Tutting","Photography","Rifle Shooting"};
